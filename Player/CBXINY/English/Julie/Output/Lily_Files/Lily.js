window.Lily_Dir = {
	...
	"items":{
		"Scene1":{
			...
			"items":{
				"Char1":{"type":"character", "name":"Lily", "left":0, "top":67, "width":200, "height":160, "artwidth":250, "artheight":200, "mode":"replace"},
				"MsgChar1Idle":{
					"type":"message", "idle":true, "character":"Char1", "frames":16,
					"onframe":{
						"0":"c.load('Img1','32D9CD1B833994481D85D697D9933793.png',237,106,106,1);c.load('Img2','4DA86AC11DD5F1C8D640985ABCFA6879.png',190,200,200,1);",
				...
				"Msg3":{"type":"message", "name":"Eyenormal", "character":"Char1", "frames":2, "datafile":"LilyMsg3.js"}
			}
		}
	}
};
