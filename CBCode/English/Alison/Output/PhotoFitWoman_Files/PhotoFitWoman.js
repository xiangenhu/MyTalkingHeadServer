window.PhotoFitWoman_Dir = {
	...
	"items":{
		"Scene1":{
			...
			"items":{
				"Char1":{"type":"character", "name":"PhotoFit Woman", "left":0, "top":67, "width":200, "height":160, "artwidth":250, "artheight":200, "mode":"replace"},
				"MsgChar1Idle":{
					"type":"message", "idle":true, "character":"Char1", "frames":16,
					"onframe":{
						"0":"c.load('Img1','914FD8149DB375E331278D10EB63D635.png',237,106,106,1);c.load('Img2','D0B43A206EB4E14276DD16E51A7BEC00.png',190,200,200,1);",
				...
				"Msg1":{"type":"message", "name":"Respond", "external":true, "url":"http://localhost/cs/cs.exe?template=Library%2FTemplates%2FServer%2FSpeech.xml&character=PhotoFitWomanHead&addons=RW2HeadClothesPack1,RW2HeadClothesPack2,RW2HeadHairPack1,RW2HeadHairPack2,RW2HeadHairPack3,RW2HeadMedicalPack,RW2HeadPropPack1&voice=Loquendo%20Allison&size=200,160&autoactionlevel=2&customtop=shirt1&customover=jacket1&customhair=susancut&flashversion=8&actionscript=3&aiengine=programd&aimldatabase=SampleBot", "method":"get", "addvariables":"Text,AIMLUser,AIMLSession,AIMLTimezone", "character":"Char1"},
				...
				"Msg3":{"type":"message", "name":"Eyenormal", "character":"Char1", "frames":2, "datafile":"PhotoFitWomanMsg3.js"}
			}
		}
	}
};
